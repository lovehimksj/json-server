 ...
 *
 * ```js
     public.config(['$resourceProvider', function($resourceProvider) {
 ...
 * ```js
 *    var public = angular.module('public', ['ngResource', 'ngRoute']);
 *
 *    // Some APIs expect a PUT request in the format URL/object/ID
 *    // Here we are creating an 'update' method
 *    public.factory('Notes', ['$resource', function($resource) {
 ...
 *    public.controller('NotesCtrl', ['$scope', '$routeParams', 'Notes',
